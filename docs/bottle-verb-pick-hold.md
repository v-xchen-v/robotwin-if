...
当前 README 与 [当前结果（沿用 v6 判据）](../result/robotwin-if-arm-only-v2-20blocks/README.md)
...
[当前结果（沿用 v6 判据）](../result/robotwin-if-arm-only-v2-20blocks/README.md)，更新 README 的 Verb / Overall。
